...
const UPLOAD_URL = `http://${window.location.hostname}:${process.env.REACT_APP_WEBSOCKET_PORT}/NFTUpload/upload`;
          ...
          <div className="field">
            <div className="control">
              <input
                ...
                type="text"
                placeholder="Enter the name of your NFTUpload"
                ref={nameInput}
                value={name}
        ...
        <div className="field-body">
          <div className="field">
            <div className="control">
              <textarea
                className="textarea"
                placeholder="Describe your NFTUpload here..."
