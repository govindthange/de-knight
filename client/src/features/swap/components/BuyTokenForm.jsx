...
function BuyTokenForm({onBuyTokens, ethBalance, tokenBalance}) {
    ...
    <form onSubmit={onSubmit}>
      <div class="field">
        ...
        <p class="help is-info">
          Input Balance: {window.web3.utils.fromWei(ethBalance, 'Ether')} ♦
        </p>
      </div>
      ...
      <div class="field">
        ...
        <p class="help is-info">
          Output Balance: {window.web3.utils.fromWei(tokenBalance, 'Ether')} ♞
        </p>
      </div>

      <div class="field">
        <div class="control">
          <strong>Exchange Rate: </strong>1 ETH = 100 CHESS
        </div>
      </div>
