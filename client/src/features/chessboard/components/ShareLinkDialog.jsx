...
function ShareLinkDialog({shouldShow, onClose}) {
  ...
  async function copyToClipboard() {
    ...
    alert('The link has been copied. Send this to your opponent and start playing.');
  }
    ...
    <div className={`modal ${shouldShow ? 'is-active' : ''}`}>
      ...
      <div className="modal-card">
        <header className="modal-card-head">
          <p className="modal-card-title">Scan to Play</p>
          ...
          <div className="container">
            <div className="columns is-centered">
              <div className="column is-half">
                <QRCode className="box" value={sharableLink} onClick={copyToClipboard} />
                ...
                <div className="empty-box has-text-right"></div>
              </div>
            </div>
          </div>
          <div className="field is-centered"></div>
        </section>
      </div>
    </div>
  );
